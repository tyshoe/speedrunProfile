        ...
        def searchUser():
            try:
                ...
                self.userNameLabel.grid(
                    row=0, column=0, padx=(5, 10), pady=(5, 5))
                ...
                self.totalRunsLabel = customtkinter.CTkLabel(frameMain, text="Total Runs: {}".format(
                    runCountData.get('totalRuns')), font=customtkinter.CTkFont(size=20))
                ...
                self.verifiedRunsLabel = customtkinter.CTkLabel(frameMain, text="Verified Runs: {}".format(
                    runCountData.get('verifiedRuns')), font=customtkinter.CTkFont(size=20))
                ...
                self.rejectedRunsLabel = customtkinter.CTkLabel(frameMain, text="Rejected Runs: {}".format(
                    runCountData.get('rejectedRuns')), font=customtkinter.CTkFont(size=20))
                ...
                self.personalBestsLabel = customtkinter.CTkLabel(frameMain, text="Personal Bests: {}".format(
                    personalBestsData.get('personalBests')), font=customtkinter.CTkFont(size=20))
                ...
                self.title = customtkinter.CTkLabel(placementsFrame, text="Podium", font=customtkinter.CTkFont(
                    size=20, weight="bold"))
                self.title.grid(row=0, column=0, padx=(5, 10), pady=(5, 5))
                self.firstPlaceLabel = customtkinter.CTkLabel(placementsFrame, text=" {}".format(personalBestsData.get(
                ...
                self.secondPlaceLabel = customtkinter.CTkLabel(placementsFrame, text=" {}".format(personalBestsData.get(
                ...
                self.thirdPlaceLabel = customtkinter.CTkLabel(placementsFrame, text=" {}".format(personalBestsData.get(
                ...
                self.errorLabel = customtkinter.CTkLabel(
                    frameMain, text="Please enter a valid user name", font=customtkinter.CTkFont(size=20, weight="bold"))
